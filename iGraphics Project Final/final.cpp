...
int levelScoreThreshold = 10; // Points required to advance to the next level
...
void drawInstructions() {
    ...
    iText(50, 360, "2. Aim for the hoop to score points.", GLUT_BITMAP_HELVETICA_18);
    iText(50, 320, "3. The game progresses to the level 2 when you score 5 points", GLUT_BITMAP_HELVETICA_18);
    iText(50, 280, "4. The game progresses to the level 3 when you score 10 points", GLUT_BITMAP_HELVETICA_18);
